...
export default {
    ...
    methods: {
        ...
        async getCategories() {
            this.isLoading = true;
            await axios.get("api/category?page="+this.pagination.current).then(response => {
        ...
        async searchItem()
        {
            await axios.get("api/search-category?keyword="+this.search).then(response => {
                this.items = response.data.data;
                this.isLoading = false;
            });
        },
        async confirmDelete() {
            await axios.delete(`api/category/${this.catid}`).then(res => {
        ...
        async submitForm() {
            if (this.$refs.form.validate()) {
                if (this.edit == false) {
                    await axios.post("api/category", this.form).then((res) => {
                    ...
                    await axios
                        .patch(`api/category/${this.catid}`, this.form)
                        .then((res) => {
                            this.$refs.form.reset();
                            this.dialog = false;
                            this.getCategories();
